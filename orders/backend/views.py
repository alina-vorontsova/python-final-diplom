...
class OrderView(ReadOnlyModelViewSet):
    """Просмотр общей информации о всех заказах
    и подробной информации об одном заказе."""
    ...
    def get_serializer_class(self):
        """Вернуть тип сериализатора с общей или подробной
        информацией в зависимости от типа запроса."""
