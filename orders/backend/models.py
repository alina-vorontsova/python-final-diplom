...
class User(AbstractUser):
    ...
    company = models.CharField(
        max_length=100, null=True, blank=True, verbose_name="Компания"
    )
    position = models.CharField(
        max_length=100, null=True, blank=True, verbose_name="Должность"
    )
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["product", "model", "shop", "external_id"],
...
class ProductParameter(models.Model):
    ...
    value = models.CharField(
        max_length=40, null=True, blank=True, verbose_name="Значение"
    )
